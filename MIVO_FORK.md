...
The fork also exposes host-facing capability controls used by the isolated fixture, including rotation and double-click policy, UI suppression, viewport constraints, and Custom Element cache behavior.
